...
namespace Drinks_Vending_Machine__.Classes
{
    ...
    {
        public Espresso(string beverage_Name, float beverage_Price, string image_Source, string[] array_Ingredients)
        ...
        {
            Espresso beverage;
            if (obj.GetType() == typeof(Espresso))
            {
                beverage = (Espresso)obj;
        ...
        {
            return $"Make your Espresso!{base.ToString()}";
        } 
        #endregion
    }
}
